...
2. Configure Store timing in Sellers profile in backend or sellers edit profile in frontend. **Show store availability** is to show store status(open/closed) on the store page and **Show store timing** is to show store timing on the store page.
