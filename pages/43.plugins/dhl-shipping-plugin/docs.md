...
Now on checkout make sure the buyer has the option to select all necessary fields when saving an address. Dhl requires buyers name, company name, country, state, district/city, zip to be saved in buyers address. Make them mandatory in your address preset.
