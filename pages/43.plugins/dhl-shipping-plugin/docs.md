...
Now on checkout make sure the buyer has the option to select all necessary fields when saving an address. Dhl requires name, company name, company, country, state, district, city, zip to be saved in buyers address.
